...
function(t, i, s) {
    function e(e, o) {
        ...
        for (var n in o) this.options[n] = o[n];
        ...
        this.directionY = 0,
        this._events = {},
        this.scale = s.min(s.max(this.options.startZoom, this.options.zoomMin), this.options.zoomMax),
        this._init(),
        this.refresh(),
    ...
    h = function() {
        ...
        o.addEvent = function(t, i, s, e) {
            ...
            t.addEventListener(i, s, { passive: !!e })
        },
        o.removeEvent = function(t, i, s, e) {
            t.removeEventListener(i, s,{ passive: !!e } )
        },
    ...
    e.prototype = {
        ...
        _move: function(t) {
            if (this.enabled && h.eventType[t.type] === this.initiated) {
                ...
                if (this.pointX = r.pageX, this.pointY = r.pageY, this.distX += a, this.distY += l, o = s.abs(this.distX), n = s.abs(this.distY), !(c - this.endTime > 300 && o < 10 && n < 10)) {
                    ...
                    this.options.scrollX || (a = this.hasHorizontalScroll ? a: 0),
                    this.options.scrollY || (l = this.hasVerticalScroll ? l: 0),
                    i = this.x + a,
                    e = this.y + l,
        ...
        refresh: function(t) {
            ...
            var i = h.getRect(this.scroller);
            this.scrollerWidth = s.round(i.width * this.scale),
            this.scrollerHeight = s.round(i.height * this.scale),
        ...
        _translate: function(t, i) {
            if (this.options.useTransform ? this.scrollerStyle[h.style.transform] = "translate(" + t + "px," + i + "px) scale(" + this.scale + ") " + this.translateZ: (t = s.round(t), i = s.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.x = t, this.y = i, this.indicators) for (var e = this.indicators.length; e--;) this.indicators[e].updatePosition()
        },
        ...
        _zoomStart: function(t) {
            ...
            this.touchesDistanceStart = s.sqrt(i * i + e * e),
            this.startScale = this.scale,
            this.originX = s.abs(t.touches[0].pageX + t.touches[1].pageX) / 2 + this.wrapperOffset.left - this.x,
            this.originY = s.abs(t.touches[0].pageY + t.touches[1].pageY) / 2 + this.wrapperOffset.top - this.y,
        ...
        _zoom: function(t) {
            if (this.enabled && h.eventType[t.type] === this.initiated) {
                ...
                this.scaled = !0,
                l < this.options.zoomMin ? l = .5 * this.options.zoomMin * s.pow(2, l / this.options.zoomMin) : l > this.options.zoomMax && (l = 2 * this.options.zoomMax * s.pow(.5, this.options.zoomMax / l)),
                i = l / this.startScale,
                e = this.originX - this.originX * i + this.startX,
                o = this.originY - this.originY * i + this.startY,
                this.scale = l,
                this.scrollTo(e, o, 0)
            }
        },
        ...
        zoom: function(t, i, s, e) {
            if (t < this.options.zoomMin ? t = this.options.zoomMin: t > this.options.zoomMax && (t = this.options.zoomMax), t != this.scale) {
                var o = t / this.scale;
                i = void 0 === i ? this.wrapperWidth / 2 - this.wrapperOffset.left: i,
                s = void 0 === s ? this.wrapperHeight / 2 - this.wrapperOffset.top: s,
                e = void 0 === e ? 300 : e,
        ...
        _wheelZoom: function(t) {
            ...
            400), "deltaY" in t) i = -t.deltaY / s.abs(t.deltaY);
            else if ("wheelDeltaY" in t) i = t.wheelDeltaY / s.abs(t.wheelDeltaY);
            else if ("wheelDelta" in t) i = t.wheelDelta / s.abs(t.wheelDelta);
            else {
                if (! ("detail" in t)) return;
                i = -t.detail / s.abs(t.detail)
            }
            isNaN(i) && (i = 0),
            e = this.scale + .01 * i,
            this.zoom(e, t.pageX, t.pageY, 0),
            t.preventDefault(),
            t.stopPropagation()
        },
        _initWheel: function() {
        ...
        _initSnap: function() {
            ...
            function() {
                ...
                if (this.pages = [], this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
                    if (this.options.snap === !0) for (e = s.round(d / 2), o = s.round(u / 2); p > -this.scrollerWidth;) {
        ...
        _nearestSnap: function(t, i) {
            ...
            for (t > 0 ? t = 0 : t < this.maxScrollX && (t = this.maxScrollX), i > 0 ? i = 0 : i < this.maxScrollY && (i = this.maxScrollY); e < o; e++) if (t >= this.pages[e][0].cx) {
                t = this.pages[e][0].x;
                break
            }
